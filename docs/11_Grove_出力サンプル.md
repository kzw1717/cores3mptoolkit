...
| :---: | --- | --- | --- | --- | --- |
| 1 | [red_led.py](../Level1_samples/red_led.py) | 104030005 | Grove - Red LED | デジタル | 赤 LED を 0.5 秒ごとに点滅 |
| 1 | [blue_led.py](../Level1_samples/blue_led.py) | 104030010 | Grove - Blue LED | デジタル | 青 LED を 0.5 秒ごとに点滅 |
