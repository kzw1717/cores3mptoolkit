...
実行 : mpremote run play_wav.py    （VSCode は Ctrl+Shift+B）
...
def setup():
    ...
    Widgets.Label("再生: " + WAV_PATH, 10, 80, 1.0, 0xFFFFFF, 0x222222, Widgets.FONTS.DejaVu18)
    print("WAV 再生 開始: {} (Ctrl-C で終了)".format(WAV_PATH))
