...
接続 : 不要（本体内蔵スピーカー）
実行 : python -m mpremote run speaker_tone.py    （VSCode は Ctrl+Shift+B）
...
def setup():
    ...
    Widgets.Label("Playing scale...", 10, 80, 1.0, 0xFFFFFF, 0x222222, Widgets.FONTS.DejaVu18)
    print("Speaker started (Ctrl-C to stop)")
